...
// End Cross Module References
	...
	DEFINE_FUNCTION(ASnakeBase::execGetElementSize)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=P_THIS->GetElementSize();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ASnakeBase::execGameOver)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->GameOver();
	...
	DEFINE_FUNCTION(ASnakeBase::execChangeMovementSpeed)
	{
	...
	void ASnakeBase::StaticRegisterNativesASnakeBase()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetElementSize", &ASnakeBase::execGetElementSize },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASnakeBase_ChangeMovementSpeed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASnakeBase, nullptr, "ChangeMovementSpeed", nullptr, nullptr, sizeof(SnakeBase_eventChangeMovementSpeed_Parms), Z_Construct_UFunction_ASnakeBase_ChangeMovementSpeed_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakeBase_ChangeMovementSpeed_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASnakeBase_ChangeMovementSpeed_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakeBase_ChangeMovementSpeed_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASnakeBase_GameOver_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASnakeBase, nullptr, "GameOver", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASnakeBase_GameOver_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakeBase_GameOver_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics
	{
		struct SnakeBase_eventGetElementSize_Parms
		{
			float ReturnValue;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SnakeBase_eventGetElementSize_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "SnakeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASnakeBase, nullptr, "GetElementSize", nullptr, nullptr, sizeof(SnakeBase_eventGetElementSize_Parms), Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ASnakeBase_GetElementSize()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ASnakeBase_GetElementSize_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASnakeBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASnakeBase_ChangeMovementSpeed, "ChangeMovementSpeed" }, // 2910059833
		{ &Z_Construct_UFunction_ASnakeBase_GameOver, "GameOver" }, // 2373993520
		{ &Z_Construct_UFunction_ASnakeBase_GetElementSize, "GetElementSize" }, // 1627937530
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASnakeBase_Statics::NewProp_ElementSize = { "ElementSize", nullptr, (EPropertyFlags)0x0010000000010005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASnakeBase, ElementSize), METADATA_PARAMS(Z_Construct_UClass_ASnakeBase_Statics::NewProp_ElementSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASnakeBase_Statics::NewProp_ElementSize_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ASnakeBase_Statics::NewProp_bCanChangeDirection = { "bCanChangeDirection", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ASnakeBase), &Z_Construct_UClass_ASnakeBase_Statics::NewProp_bCanChangeDirection_SetBit, METADATA_PARAMS(Z_Construct_UClass_ASnakeBase_Statics::NewProp_bCanChangeDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASnakeBase_Statics::NewProp_bCanChangeDirection_MetaData)) };
	...
	IMPLEMENT_CLASS(ASnakeBase, 603133539);
